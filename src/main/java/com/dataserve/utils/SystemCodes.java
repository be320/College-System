...
public class SystemCodes {
	...
	public static enum StatusMessages {
		...
		OK("INFO_200_001", "Success Operation"), CREATED("INFO_200_002", "Data added successfully"),
		UPDATED("INFO_200_003", "Data updated successfully"), DELETED("INFO_200_004", "Data deleted successfully"),
		RECEIVED("INFO_200_005", "Data received successfully"),

		// 400s status messages
		REQUIRED_DATA_MISSING("ERROR_400_001", "is Required"), DATA_NOT_EXISTING("ERROR_400_002", "does not exist"),
