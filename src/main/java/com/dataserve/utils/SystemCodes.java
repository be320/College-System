...
public class SystemCodes {
	...
	public static enum StatusMessages {
		...
		REQUIRED_DATA_MISSING("ERROR_400_001", "{0} is Required"),
		DATA_NOT_EXISTING("ERROR_400_002", "{0} with value {1} does not exist"),
		DATA_VALUE_INVALID("ERROR_400_003", "{0} : {1} is not valid for type {2}"),
